...
export const metadata = {
    ...
    description: "This week we in Cloud Platforms (Telenor Norway) hosted the Offentlig PaaS community meetup at Fornebu. Offentlig PaaS is a network for technologists in public sector in Norway, that focuses on whose who build and operate digital services, with large focus on platforms, application, architecture and security.",
    slug: "offentlig-paas",
    image: image,
    authors: ['mats'],
    date: "2025-10-17",
